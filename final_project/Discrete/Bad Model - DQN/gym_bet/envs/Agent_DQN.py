            ...
            for EXPLORATION_DECAY in EXPLORATION_DECAY_set:
                ...
                for i in np.arange(600):
                    ...
                    while True:
                        ...
                        if money>objectif:
                            objectif = objectif + 500
                            reward +=100
                        elif money<objectif-1000:
                            objectif = objectif - 500
                        ...
                        if terminal:
                            ...
                            print("Run: " + str(run) + ", exploration: " + str(dqn_solver.exploration_rate) +\
                                  ", score: " + str(step) + " money: " + str(reward), " action", actions)
                        ...
                        if step > 3300:
                            ...
                            reward += 2000
                            print("ok2", money)
                            print("Run: " + str(run) + ", exploration: " + str(
                                dqn_solver.exploration_rate) + ", score: " + str(step) + " money: " + str(reward),
                                  " action", actions)
                            rewards.append(reward)
                            steps.append(step)
                            wallet.append(money)
