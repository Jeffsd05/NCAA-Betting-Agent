...
class BetEnv(gym.Env):
	...
	def __init__(self, datadir):
		...
		self.action_space = spaces.Discrete(NUMBER_ACTION)
		# actions
		if NUMBER_ACTION==2:
			self.ACTION_BET1 = 0
			self.ACTION_BET2 = 1
